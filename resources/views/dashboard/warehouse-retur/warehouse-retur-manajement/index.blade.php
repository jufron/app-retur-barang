          ...
          <div class="col-12">
              <div class="card">
                  ...
                  <div class="card-content">
                      <div class="card-body">
                          <a href="{{ route('wr.warehouse-retur.create') }}" class="btn btn-primary mb-4">Tambah Warehouse Retur</a>
                                  ...
                                  <tbody>
                                    @foreach ($users as $user)
                                      <tr>
                                          ...
                                          <td>
                                            <form id="form-delete" action="{{ route('wr.warehouse-retur.destroy', $user) }}" method="post">
                                              @method('delete')
                                              @csrf
                                              <button id="button-info" class="btn btn-info rounded-4" type="button" data-url="{{ route('wr.warehouse-retur.show', $user) }}">
                                                <i class="fa-solid fa-info"></i>
                                              </button>
                                              <a href="{{ route('wr.warehouse-retur.edit', $user) }}" class="btn icon btn-warning text-white rounded-4">
