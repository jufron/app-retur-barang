          ...
          <div class="col-12">
              <div class="card">
                  ...
                  <div class="card-content">
                      <div class="card-body">
                          <a href="{{ route('wr.barang-sortir.create') }}" class="btn btn-primary mb-4">Tambah Barang Sortir</a>
                                  ...
                                  <tbody>
                                    @foreach ($barangSortir as $bs)
                                      <tr>
                                          ...
                                          <td>
                                            <form id="form-delete" action="{{ route('wr.barang-sortir.destroy', $bs) }}" method="post">
                                              @method('delete')
                                              @csrf
                                              <div class="d-flex">
                                                <button id="button-info" class="btn btn-info rounded-4" type="button" data-url="{{ route('wr.barang-sortir.show', $bs) }}">
                                                  <i class="fa-solid fa-info"></i>
                                                </button>
                                                <a href="{{ route('wr.barang-sortir.edit', $bs) }}" class="btn icon btn-warning text-white rounded-4">
