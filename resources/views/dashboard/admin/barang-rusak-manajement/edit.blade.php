        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form id="form" action="{{ route('admin.barang-rusak.update', $barangRusak) }}" method="post" data-url-search="{{ route('admin.barang-rusak.search') }}">
                  @method('patch')
                  @csrf
                  @error('barang_id')
                  <div class="col-md-6">
                  ...
                  @enderror
                  <input type="hidden" name="barang_id" id="barang_id" value="{{ $barangRusak->barang_id }}">
                  <div class="row">
                    <div class="col-sm-6">
                      <x-dashboard.input.form-input
                        ...
                        value="{{ old('nama_barang', $barangRusak->barang->nama_barang) }}"
                        :disable="true"
                      />
                    </div>
                    <div class="col-sm-4">
                      <x-dashboard.input.form-input
                        ...
                        value="{{ old('kategory', $barangRusak->barang->kategory->name) }}"
                        :disable="true"
                      />
                    </div>
                  ...
                  <div class="col-md-4">
                    <x-dashboard.input.form-input
                      ...
                      value="{{ old('barcode', $barangRusak->barang->kode_barcode) }}"
                    />
                  </div>
                  <div class="my-4">
