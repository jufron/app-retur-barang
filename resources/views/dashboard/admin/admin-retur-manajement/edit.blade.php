<x-dashboard.app title="Ubah retur dashboard">
  <x-slot:header>
      <div class="page-heading">
          <h3 class="my-2">Ubah Admin Retur</h3>
      </div>
  </x-slot:header>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                      <form action="{{ route('admin.admin-retur.update', $user) }}" method="post" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <div class="row">
                          <div class="col-sm-4">
