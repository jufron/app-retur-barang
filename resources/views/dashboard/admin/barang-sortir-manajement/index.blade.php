                                  ...
                                  <tbody>
                                    @foreach ($barangSortir as $bs)
                                      <tr>
                                          ...
                                          <td>
                                            <form id="form-delete" action="{{ route('admin.barang-sortir.destroy', $bs) }}" method="post">
                                              @method('delete')
                                              @csrf
                                              <div class="d-flex">
                                                <button id="button-info" class="btn btn-info rounded-4" type="button" data-url="{{ route('admin.barang-sortir.show', $bs) }}">
                                                  <i class="fa-solid fa-info"></i>
                                                </button>
                                                <a href="{{ route('admin.barang-sortir.edit', $bs) }}" class="btn icon btn-warning text-white rounded-4">
