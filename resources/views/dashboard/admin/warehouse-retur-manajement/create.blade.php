<x-dashboard.app title="Tambah Warehouse Retur">
  <x-slot:header>
      <div class="page-heading">
          <h3 class="my-2">Tambah Warehouse Retur</h3>
      </div>
  </x-slot:header>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                      <form action="{{ route('admin.warehouse-retur.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                          <div class="col-sm-4">
