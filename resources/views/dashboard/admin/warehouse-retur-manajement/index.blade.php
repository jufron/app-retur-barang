<x-dashboard.app title="Warehouse retur dashboard">
  ...
  <x-slot:header>
      <div class="page-heading">
          <h3 class="my-2">Warehouse Retur Manajement</h3>
      </div>
  </x-slot:header>
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h4 class="card-title">List Warehouse Retur</h4>
                  </div>
                  <div class="card-content">
                      <div class="card-body">
                          <a href="{{ route('warehouse-retur.create') }}" class="btn btn-primary mb-4">Tambah Admin Retur</a>
                                  ...
                                  <tbody>
                                    @foreach ($users as $user)
                                      <tr>
                                          ...
                                          <td>
                                            <form id="form-delete" action="{{ route('warehouse-retur.destroy', $user) }}" method="post">
                                              @method('delete')
                                              @csrf
                                              <button id="button-info" class="btn btn-info rounded-4" type="button" data-url="{{ route('warehouse-retur.show', $user) }}">
                                                <i class="fa-solid fa-info"></i>
                                              </button>
                                              <a href="{{ route('warehouse-retur.edit', $user) }}" class="btn icon btn-warning text-white rounded-4">
  ...
  <x-slot:scriptOptional>
    ...
    {{-- ? my script --}}
    <script type="module" src="{{ asset('js/admin-retur/warehouse-retur-manajement/warehouse-retur.js') }}"></script>
  </x-slot:scriptOptional>
</x-dashboard.app>