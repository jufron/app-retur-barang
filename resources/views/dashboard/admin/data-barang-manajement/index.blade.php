          ...
          <div class="col-12">
              <div class="card">
                  ...
                  <div class="card-content">
                      <div class="card-body">
                          <a href="{{ route('admin.barang.create') }}" class="btn btn-primary mb-4">Tambah Barang Retur</a>
                                  ...
                                  <tbody>
                                    @foreach ($barang as $b)
                                      <tr>
                                          ...
                                          <td>{{ $b->updated_at }}</td>
                                          <td>
                                            <form id="form-delete" action="{{ route('admin.barang.destroy', $b) }}" method="post">
                                              @method('delete')
                                              @csrf
                                              <div class="d-flex">
                                                <button id="button-info" class="btn btn-info rounded-4" type="button" data-url="{{ route('admin.barang.show', $b) }}">
                                                  <i class="fa-solid fa-info"></i>
                                                </button>
                                                <a href="{{ route('admin.barang.edit', $b) }}" class="btn icon btn-warning text-white rounded-4">
