<x-dashboard.app title="Daftar Warehouse Asisten">
  ...
  <x-slot:header>
      <div class="page-heading">
          <h3 class="my-2">User Logistik Manajement</h3>
      </div>
  </x-slot:header>
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h4 class="card-title">List Logistik User</h4>
                  </div>
                  <div class="card-content">
                      <div class="card-body">
                          <a href="{{ route('admin.logistik-manajement.create') }}" class="btn btn-primary mb-4">Tambah User Logistik</a>
                                  ...
                                  <tbody>
                                    @foreach ($users as $user)
                                      <tr>
                                          ...
                                          <td>
                                            <form id="form-delete" action="{{ route('admin.logistik-manajement.destroy', $user) }}" method="post">
                                              @method('delete')
                                              @csrf
                                              <button id="button-info" class="btn btn-info rounded-4" type="button" data-url="{{ route('admin.logistik-manajement.show', $user) }}">
                                                <i class="fa-solid fa-info"></i>
                                              </button>
                                              <a href="{{ route('admin.logistik-manajement.edit', $user) }}" class="btn icon btn-warning text-white rounded-4">
