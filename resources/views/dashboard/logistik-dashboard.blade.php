  ...
  <div class="page-content">
      <section class="row">
          <div class="col-12 col-lg-9">
              <div class="row" id="dashboard" data-url="{{ route('dashboard.logistik.fetch-data') }}">
  ...
  <x-slot:scriptOptional>
    ...
    <script>
      ...
      fetch(getURL)
        ...
        .then(result => {
          const {dataLogistikCount} = result.data;
          logistikCountValue.innerHTML = dataLogistikCount;
        })
        .catch(error => {
          console.error(error);
        });
