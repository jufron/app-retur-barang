...
class BarangSortirController extends Controller
{
    ...
    */
    ...
    {
        return view('dashboard.admin.barang-sortir-manajement.index', [
    ...
    */
    ...
    {
        return view('dashboard.admin.barang-sortir-manajement.create');
    }
    /**
    ...
    public function store(BarangSortirRequest $request) : RedirectResponse
    {
        ...
        return redirect()->route('admin.barang-sortir.index');
    }
    ...
    */
    ...
    {
        return view('dashboard.admin.barang-sortir-manajement.edit', compact('barangSortir'));
    }
