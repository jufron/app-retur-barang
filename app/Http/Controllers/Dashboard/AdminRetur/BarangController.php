...
class BarangController extends Controller
{
    ...
    {
        return view('dashboard.admin.data-barang-manajement.index', [
    ...
    {
        return view('dashboard.admin.data-barang-manajement.create', [
    ...
    {
        return view('dashboard.admin.data-barang-manajement.edit', [
            'barang'    => $barang,
            'kategory'  => $this->barangService->getKategory()
        ]);
    }
